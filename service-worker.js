...
const CACHE_NAME    = 'dompetku-v1.0.0';
...
self.addEventListener('fetch', (event) => {
  ...
  if (request.mode === 'no-cors' && url.hostname === 'script.google.com') return;
...
self.addEventListener('push', (event) => {
  let data = { title: 'DompetKu', body: 'Jangan lupa catat pengeluaran hari ini!' };
  try {
